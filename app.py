...
def init_db():
    ...
    db.execute("""
        CREATE TABLE IF NOT EXISTS usuarios (
            ...
            vendedor_aprovado INTEGER NOT NULL DEFAULT 0,
...
def eh_admin():
    ...
    return usuario["email"].lower() == ADMIN_EMAIL.lower()
...
<a href="{{ url_for('cadastro') }}" class="btn">
Criar conta
</a>
...
def index():
    ...
    <section class="hero">
        ...
        <div class="hero-content">
            ...
            <p>
                Fardamentos, livros e materiais
                escolares por preços acessíveis.
            </p>
    ...
    <main>
        ...
        <div class="section-header">
            ...
            {% if session.get("usuario_id")
                  and session.get("tipo") == "vendedor"
                  and session.get("vendedor_aprovado") == 1 %}
...
def cadastro():
    ...
    if request.method == "POST":
        ...
        session["vendedor_aprovado"] = usuario[
            "vendedor_aprovado"
        ]
        session["eh_admin"] = (
            usuario["email"].lower()
...
def login():
    ...
    if request.method == "POST":
        ...
        if (
            ...
            session["usuario_nome"] = usuario["nome"]
            session["tipo"] = usuario["tipo"]
            session["vendedor_aprovado"] = (
                usuario["vendedor_aprovado"]
            )
            session["eh_admin"] = (
                usuario["email"].lower()
                == ADMIN_EMAIL.lower()
...
def vender():
    ...
    <main>
        ...
        <div class="form-card">
            ...
            <p>
                Publique seu produto para outros
                usuários do MarketClass.
            </p>
...
def perfil():
    ...
    if usuario["tipo"] == "vendedor":
        ...
        if usuario["vendedor_aprovado"] == 1:
...
def admin():
    ...
    for vendedor in vendedores:
        ...
        if vendedor["vendedor_aprovado"] == 1:
        ...
        whatsapp_admin = (
            ...
            f"?text="
            f"Olá%20administrador.%20"
            f"Quero%20falar%20sobre%20a%20aprovação%20"
            f"do%20vendedor%20{vendedor['nome']}."
        )

        botoes = ""

        if vendedor["vendedor_aprovado"] == 0:

            botoes = f"""

            <a
                href="/aprovar-vendedor/{vendedor['id']}"
                class="btn green"
            >
                Aprovar vendedor
            </a>
            ...
            <a
                href="/rejeitar-vendedor/{vendedor['id']}"
                class="btn red"
            >
                Rejeitar
            </a>
    ...
    <main>
        ...
        <div class="profile">
            ...
            <div class="profile-box">
                ...
                <p>
                    Aqui você pode verificar e aprovar
                    os vendedores do MarketClass.
                </p>
...
@app.route(
    "/aprovar-vendedor/<int:usuario_id>"
)
...
# ============================================================
# REJEITAR / RETIRAR APROVAÇÃO
# ============================================================

@app.route(
    "/rejeitar-vendedor/<int:usuario_id>"
)
def rejeitar_vendedor(usuario_id):
    ...
    flash(
        "Aprovação do vendedor removida."
    )
